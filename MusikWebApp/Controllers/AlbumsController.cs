...
namespace MusikWebApp.Controllers
{
    ...
    {
        private readonly MusikWebAppContext _context;

        public AlbumsController(MusikWebAppContext context)
        {
            _context = context;
        }
        ...
        {
            var musikWebAppContext = _context.Album.Include(a => a.Artist).Include(a => a.Genre);
            return View(await musikWebAppContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusikWebAppContext.Album'  is null.");
            }
            var album = await _context.Album.FindAsync(id);
            if (album != null)
            {
