...
namespace MusikWebApp.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(MusikWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artist != null ? 
                          ...
                          Problem("Entity set 'MusikWebAppContext.Artist'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusikWebAppContext.Artist'  is null.");
            }
            var artist = await _context.Artist.FindAsync(id);
            if (artist != null)
            {
